    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('diseases.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <x-forms.input label="Name" placeholder="Enter Name" :errors="$errors->get('name')" :value="old('name')" input-name="name" input-id="name" :required="true" />
                    </div>
                </div>
                <div id="conditions_container">
                    <div data-repeater-list="conditions" >
                        @if(old('conditions') and is_array(old('conditions')) and (count(old('conditions')) > 0))
                            @foreach(old('conditions') as $k=>$condition)
                        ...
                        @else
                            <div data-repeater-item>
                                <div class="d-flex flex-row justify-content-center">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="type" value="main" checked >
                                            Main
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="type" value="and" >
                                            And
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="type" value="or" >
                                            Or
                                        </label>
                                    </div>
                                </div>
                                <div class="row mt-3" >
                                    <div class="col-md-2">
                                        <x-forms.input label="Any" type="number" step="1" min="1" placeholder="" :errors="$errors->get('compulsory_symptoms')" input-name="compulsory_symptoms" input-id="compulsory_symptoms" :required="true" :value="old('compulsory_symptoms')" />
                                    </div>
                                    <div class="col-md-10">
                                        <div id="cases_container">
                                            <div data-repeater-list="cases">
                                                <div class="row mb-3" data-repeater-item >
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="case" class="form-control cases_selector" data-placeholder="Select Case" >
                                                                ...
                                                                <optgroup label="Symptoms">
                                                                    @foreach($symptoms as $symptom)
                                                                        <option value="symptom_{{$symptom->id}}">{{$symptom->name}}</option>
                                                                    @endforeach
                                                                </optgroup>
                                                                <optgroup label="Crterias">
                                                                    @foreach($criterias as $criteria)
                                                                        <option value="criteria_{{$criteria->id}}">{{$criteria->name}}</option>
                                                                    @endforeach
                                                                </optgroup>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Times in Last 24 hours</label>
                                                            <input type="number" name="times" class="form-control" value="1" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        {{--                                                <x-forms.input type="select" :options="[['label' => 'Yes','value' => 1],['label' => 'No','value' => 0]]" label="Must Include" input-name="must_include" input-id="must_include" :value="null" placeholder="Select Must Include" />--}}
                                                        <div class="form-check mt-4">
                                                            <label class="form-check-label" >
                                                                <input class="form-check-input" type="checkbox" value="1" name="must_include" />
                                                                Must Include
                                                            </label>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>O2 Difference Value</label>
                                            <input type="number" name="o2_saturation_difference_value" class="form-control" step="0.01">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <button data-repeater-delete class="btn btn-danger mt-4" type="button" >Delete Condition</button>
